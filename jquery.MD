...
Pored velikih JS blokova koji se nalaze unutar `script` tagova, često imate i *inline* pozive JS funkcija. Uklonite i to, iz gore navedenih razloga. Dakle, ako ste imali:
