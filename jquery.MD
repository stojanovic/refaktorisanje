...
Postoji gomila rešenja za [učitavanje](https://developer.mozilla.org/en/docs/web/javascript/reference/statements/import) modula (npr. RequireJS, CommonJS, Webpack...), a možete sve to rešiti i [ručno](https://github.com/mudroljub/js-async-loader). [AMD](https://en.wikipedia.org/wiki/Asynchronous_module_definition) alatke nam omogućuju da eksplicitno navedemo od kojih biblioteka naša skripta zavisi, pa se kod izvršava tek pošto se zavisnosti učitaju.
